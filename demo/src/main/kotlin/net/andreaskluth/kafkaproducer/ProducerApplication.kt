...
fun main(args: Array<String>) {
    FlawedProducer().produce()
}

class FlawedProducer {

    companion object {
        val log = LoggerFactory.getLogger(FlawedProducer::class.java.simpleName)
    }
    ...
    fun logAsyncResponse(i: Int): (RecordMetadata?, Exception?) -> Unit {
